...
exports.metadata = {
  metadataBase: function () {
    try {
      ...
      console.error("Invalid URL:", resume_1.DATA.url, e); // Fallback to a default URL if invalid
...
function RootLayout(_a) {
  ...
  }, React.createElement("body", null, React.createElement(theme_provider_1.ThemeProvider, {
    attribute: "class",
    defaultTheme: "Smoke",
    value: {
      Smoke: "#F5F5F5"
    }
  }, React.createElement(tooltip_1.TooltipProvider, {
    delayDuration: 0
  }, children, React.createElement(navbar_1["default"], null)))));
}
