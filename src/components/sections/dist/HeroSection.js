...
var HeroSection = function () {
    return (React.createElement(MaxWidthWrapper_1["default"], { className: "grid min-h-screen grid-cols-1 items-center sm:grid-cols-2 relative" },
        ...
        React.createElement("div", { className: "relative flex h-full w-full max-w-[28rem] sm:max-w-[32rem] items-center justify-center overflow-hidden rounded-lg bg-background mt-6" },
            React.createElement(orbiting_circles_1["default"], { className: "h-[35px] w-[35px] sm:h-[40px] sm:w-[40px] border-none bg-transparent", duration: 20, delay: 0, radius: 90 },
                React.createElement(icons_1.Icons.java, { className: "h-6 w-6 sm:h-8 sm:w-8" })),
            React.createElement(orbiting_circles_1["default"], { className: "h-[35px] w-[35px] sm:h-[40px] sm:w-[40px] border-none bg-transparent", duration: 20, delay: 5, radius: 90 },
            ...
            React.createElement(orbiting_circles_1["default"], { className: "h-[35px] w-[35px] sm:h-[40px] sm:w-[40px] border-none bg-transparent", duration: 20, delay: 15, radius: 90 },
