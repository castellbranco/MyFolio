...
function ProjectCard(_a) {
    ...
    return (React.createElement(card_1.Card, { className: utils_1.cn("flex flex-col overflow-hidden border border-gray-300 shadow-md hover:shadow-lg transition-all duration-300 ease-out h-full bg-white", className) },
        React.createElement(link_1["default"], { href: href || "#", className: "block cursor-pointer" },
        ...
        React.createElement(card_1.CardHeader, { className: "px-2" },
            React.createElement("div", { className: "space-y-1" },
                React.createElement(card_1.CardTitle, { className: "mt-1 text-base" }, title),
        ...
        React.createElement(card_1.CardContent, { className: "mt-auto flex flex-col px-2" }, tags && tags.length > 0 && (React.createElement("div", { className: "mt-2 flex flex-wrap gap-1" }, tags === null || tags === void 0 ? void 0 : tags.map(function (tag) { return (React.createElement(badge_1.Badge, { className: "px-1 py-0 text-[10px]", variant: "secondary", key: tag }, tag)); })))),
        React.createElement(card_1.CardFooter, { className: "px-2 pb-2" }, links && links.length > 0 && (React.createElement("div", { className: "flex flex-row flex-wrap items-start gap-1" }, links === null || links === void 0 ? void 0 : links.map(function (link, idx) { return (React.createElement(link_1["default"], { href: link === null || link === void 0 ? void 0 : link.href, key: idx, target: "_blank" },
