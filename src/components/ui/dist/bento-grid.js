...
var BentoCard = function (_a) {
    ...
    return (React.createElement("div", { key: name, className: utils_1.cn("group relative col-span-3 flex flex-col justify-between overflow-hidden rounded-xl", 
        ...
        React.createElement("div", { className: "pointer-events-none z-10 flex transform-gpu flex-col gap-1 p-6 transition-all duration-300 group-hover:translate-y-[-10rem]" },
            React.createElement(Icon, { className: "h-12 w-12 origin-left transform-gpu text-neutral-700 transition-all duration-300 ease-in-out group-hover:scale-75 group-hover:translate-y-[-5rem]" }),
            React.createElement("h3", { className: "text-xl font-semibold text-neutral-700 dark:text-neutral-300 transition-all duration-300 ease-in-out group-hover:opacity-0" }, name),
            React.createElement("p", { className: "max-w-lg text-neutral-400 transition-all duration-300 ease-in-out group-hover:opacity-0" }, description)),
        ...
        React.createElement("div", { className: utils_1.cn("pointer-events-none absolute bottom-0 flex w-full translate-y-10 transform-gpu flex-col items-start p-4 opacity-0 transition-all duration-300 group-hover:translate-y-0 group-hover:opacity-100") },
            React.createElement("p", { className: "text-neutral-700 dark:text-neutral-300" }, desc),
            React.createElement("ul", { className: "list-disc pl-5 text-neutral-700 dark:text-neutral-300" }, technologie.map(function (tech, index) { return (React.createElement("li", { key: index }, tech)); })),
